...
class HomeVC: UIViewController, MovieProtocol {
    ...
    let tableView = {
        ...
        tv.register(GenreAgeTVC.self, forCellReuseIdentifier: "GenreCell")
...
extension HomeVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if mainMovies[indexPath.row].cellType == .genre ||
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "GenreCell") as! GenreAgeTVC
            cell.delegate = self
            cell.backgroundColor = .clear
        ...
        cell.button1Action = { [weak self] in
            guard let categoryId = self?.mainMovies[indexPath.row].categoryId else { return }
