...
class MainBannerTableViewCell: UITableViewCell {
    ...
    let collectionView = {
        ...
        cv.register(MainBannerCollectionViewCell.self, forCellWithReuseIdentifier: "MainBannerCVC")
...
extension MainBannerTableViewCell: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "MainBannerCVC", for: indexPath) as! MainBannerCollectionViewCell
