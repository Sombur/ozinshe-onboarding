...
class MovieInfoVC: UIViewController {
    ...
    let seasonButton = {
        ...
        button.sizeToFit()
        button.setTitleColor(UIColor(named: "TextGray4"), for: .normal)
    ...
    let screenshotCollectionView = {
        ...
        cv.register(MovieInfoCell.self, forCellWithReuseIdentifier: "MovieCell")
    ...
    let sameCollectionView = {
        ...
        let cv = UICollectionView(frame: .zero, collectionViewLayout: layout)
        cv.register(SameCVC.self, forCellWithReuseIdentifier: "SameCell")
        cv.backgroundColor = .clear
        cv.isPagingEnabled = true
        cv.isScrollEnabled = true
        cv.showsHorizontalScrollIndicator = false
...
extension MovieInfoVC: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if collectionView == self.sameCollectionView {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "SameCell", for: indexPath) as! SameCVC
        ...
        let cell = screenshotCollectionView.dequeueReusableCell(withReuseIdentifier: "MovieCell", for: indexPath) as! MovieInfoCell
