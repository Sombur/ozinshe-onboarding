...
class SeasonsSeriesViewController: UIViewController {
    ...
    let seriasCollectionView: UICollectionView = {
        ...
        cv.register(SeasonsCollectionViewCell.self, forCellWithReuseIdentifier: "SeasonsCVC")
    ...
    let seriasTableView = {
        ...
        tv.register(SeasonsTableViewCell.self, forCellReuseIdentifier: "SeasonsTVC")
...
extension SeasonsSeriesViewController: UICollectionViewDelegate, UICollectionViewDataSource, UITableViewDelegate, UITableViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "SeasonsCVC", for: indexPath) as! SeasonsCollectionViewCell
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "SeasonsTVC", for: indexPath) as! SeasonsTableViewCell
